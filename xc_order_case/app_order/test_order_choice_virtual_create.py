...
class TestAppOrderChoiceCreate():
    ...
    @pytest.mark.parametrize("method, url, params, data, headers, cookies, proxies, status_code, expectData, name",
                             test_cases)
    def test_createChoiceVirtualOrder(self, dheaders, method, url, params, data, headers, cookies, proxies, status_code,
    ...
    @allure.title("精选商品-虚拟品-取消订单")
    @allure.description("精选商品-虚拟品-取消订单")
    ...
    @allure.title("精选商品-虚拟品-删除订单")
    @allure.description("精选商品-虚拟品-删除订单")

...
# 数据准备
casepath = findCase(__file__, 'uc_inner_dbinfo_shop.yml', n=2)
...
class TestUcenterInnerDbInfoShop():
    ...
    @pytest.mark.parametrize("method, url, params, data, headers, cookies, proxies, status_code, expectData, name",
                             test_cases)
    def test_inner_dbinfo_shop(self, method, url, params, data, headers, cookies, proxies, status_code, expectData, name):
